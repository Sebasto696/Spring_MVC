            ...
            <div class="container mt-4 col-lg-4">
                <div class="card">
                    <div class="card-header bg-dark">
                        <h4 class="text-center">Update a person</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" class="text-center">
                            ...
                            <input type="text" name="telefono" value="${lista[0].Telefono}" class="form-control" />
                            
                            <input type="submit" value="Update" class="btn btn-success rounded-pill"/>
                            <a href="index.htm" class="btn btn-danger rounded-pill">Go back</a>
                        </form>
                    </div>
                </div>
            </div>
